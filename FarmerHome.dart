...
import 'package:flutter_application_1/buynow.dart';
import 'package:flutter_application_1/cart.dart';
import 'package:flutter_application_1/orders.dart';
import 'package:flutter_application_1/profile.dart';
import 'package:flutter_application_1/supplies.dart';
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Expanded(
                    child: InfoCard(
                        title: "Today's Supply", value: "25 Liters"),
                  ),
                  SizedBox(width: 10),
                  Expanded(
                    child: InfoCard(
                        title: "Payment Received", value: "₹1,200"),
                  ),
                ],
              ),
              SizedBox(height: 20),
    ...
    return Drawer(
      child: Column(
        children: [
          ...
          ListTile(leading: Icon(Icons.home), title: Text("Home"), onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => FarmerHome(),));}),
          ListTile(leading: Icon(Icons.shelves), title: Text("Supplies"), onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => SuppliesHistoryPage(),));}),
          ListTile(
              leading: Icon(Icons.shopping_bag), title: Text("My Orders"), onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => MyOrdersPage(),));}),
          ListTile(leading: Icon(Icons.shopping_cart), title: Text("Cart"), onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => CartPage(),));}),
          ListTile(leading: Icon(Icons.person), title: Text("Profile"), onTap: () {Navigator.push(
      context,
...
class ProductList extends StatelessWidget {
  ...
  MaterialPageRoute(
    builder: (context) => BuyNowPage(
      product: {
        "productName": "Cattle Feed Premium",  // Product name
        "price": 50.0,                        // Product price
        "quantity": 1,                        // Default quantity
        "image": "https://via.placeholder.com/300x200", // Product image URL
      },
    ),
  ),
);
